            ...
            <div class="col-lg-8">
                <div class="row g-3">
                    <div class="col-sm-6">
                        <div class="card">
                            <img
                                src="./php-course-blog-template/app-template/assets/images/4.jpg"
                                class="card-img-top"
                                alt="post-image" />
                            <div class="card-body">
                                <div
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <img
                                src="./php-course-blog-template/app-template/assets/images/5.jpg"
                                class="card-img-top"
                                alt="post-image" />
                            <div class="card-body">
                                <div
                                    ...
                                    <div>
                                        <span
                                            class="badge text-bg-secondary">گردشگری</span>
                                    </div>
                                </div>
                                <p
                                    class="card-text text-secondary pt-3">
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <img
                                src="./php-course-blog-template/app-template/assets/images/6.jpg"
                                class="card-img-top"
                                alt="post-image" />
                            <div class="card-body">
                                <div
                                    ...
                                    <div>
                                        <span
                                            class="badge text-bg-secondary">متفزقه</span>
                                    </div>
                                </div>
                                <p
                                    class="card-text text-secondary pt-3">
